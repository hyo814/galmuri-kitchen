...
cd frontend && npm run e2e                                 # 화면 단위 테스트(Playwright) 78개 — 처음 한 번 npx playwright install chromium
```
...
| 테스트 | 백엔드 1,608개(SQLite·PostgreSQL 통과), 프론트 검사 스크립트 11개, E2E(Playwright) 78개 |
