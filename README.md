...
- **쇼핑몰에서 한꺼번에 찾기**: 살 것이 여러 개면 쇼핑몰을 한 번만 고르고 품목마다 찾기 링크를 차례로 엽니다. 몇 개 열어봤는지 보여 주고, 지난번 고른 쇼핑몰을 다음에 맨 앞으로 기억합니다. 쿠팡·네이버 쇼핑·이마트몰은 낮은 가격순으로 확인돼 있습니다.
...
| 순서 | 내용 |
|---|---|
| 완료 | Render 배포, 4b-2 영양 계산, 4b-3 먹은 기록, 5 요리 일기·집밥 리포트, 레시피 상세 재고 남은 양·다 썼어요 표시, 쇼핑몰에서 한꺼번에 찾기, 여러 요리 가져오기, 요리 일기 직접 쓰기, 식약처 레시피 전체 동기화 |
| 운영 | 쇼핑몰 7곳 중 나머지 4곳 정렬 링크 폰 확인, 회원 탈퇴 버튼 |
