 ...
 *  - note: 누를 것 없는 메모 한 줄. 농부님 이름은 국내 몰 상품명에 거의 안 적혀서(2026-09-20 컬리 검색으로 12개 조합 확인 — 이름이 든 상품 0개,
 *    느슨한 검색이라 이름을 붙이면 엉뚱한 상품이 1등) 검색어로 쓰지 않고, 마트 진열대에서 라벨을 볼 때 떠올리도록 글자만 보여준다.
...
export const PICKS: Pick[] = [
  ...
  // 마트에서 보이면 무조건 사는 농부님(사용자 명단). `샤인`은 샤인머스캣·샤인머스켓 두 표기를 다 잡는다
