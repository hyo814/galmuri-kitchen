...
| 묶음 | 항목 | 만드는 시점 |
|---|---|---|
| **기록** | 먹은 기록(24절 달력, 4b-3 완료) · 요리 일기(5단계 완료) · 집밥 리포트 | 4b · 5 · 집밥 리포트는 5단계 뒤 |
