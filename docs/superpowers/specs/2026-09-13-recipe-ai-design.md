...
단계별 상세는 14~21절(2026-09-13 추가 요구사항)이 4~7절보다 우선한다.
...
하단 탭(사용자 결정 2026-09-13): **재고 · 레시피 · 장보기 · 식단 · 더보기**. 기능이 생긴 단계부터 탭을 노출한다. 첫 탭 제목은 `내 재고`.
...
### 하루 필요 칼로리
- 입력: 성별, 나이, 키(cm), 몸무게(kg), 활동량(거의 없음·가벼움·보통·많음·매우 많음). 설정 > `내 몸 정보`에 저장, 언제든 수정·삭제.
