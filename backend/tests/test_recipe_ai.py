...
def test_ai_recipes_real_call_cleans_marks_urgent_and_logs_tokens(client, login, app, monkeypatch):
    ...
    assert body["recipes"][0] == {
        ...
        "minutes": 20,
        "ingredients": [
            {"name": "두부", "amount": "1큰술", "have": True, "matched_name": "두부", "stock_quantity": None, "stock_unit": None},
            {"name": "간장", "amount": "1큰술", "have": False, "matched_name": None, "stock_quantity": None, "stock_unit": None},
        ],
        "steps": ["썰어요.", "졸여요."],
        "urgent_names": ["두부"],
        "image_url": None,
