...
class AiCall(db.Model):
    ...
    kind = db.Column(db.String(20), nullable=False)  # fridge | receipt | order | memo | recipe | link | meal | link_fetch·channel_add·video_refresh(외부 요청 기록)·export(데이터 내보내기), 모두 모델·토큰 없음
